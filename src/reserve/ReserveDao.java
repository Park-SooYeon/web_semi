...
public class ReserveDao {
	...
	protected boolean insert(ReserveVo vo) {
		...
		try {			
			sql = "insert into reserve(rNo, rsName, rPhone, rCode, roomCode, rdate, period, payment, price, email, checkin, checkout) "
	...
	// 디비에 데이터 삭제
	protected boolean delete(int rNo, int rCode, int roomCode, String email) {
		boolean result = false;
	...
	protected ReserveVo roomView(String rCode, String roomCode, String checkIn, String checkOut) {
		...
		try {
			sql = "select a.rName c, to_char(a.checkin, 'HH24:MI') d, to_char(a.checkout, 'HH24:MI') e, b.roomName f, b.price g "
