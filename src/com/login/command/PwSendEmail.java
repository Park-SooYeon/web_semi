...
public class PwSendEmail {
	public boolean send(String toE) {
        ...
        sb.append("<a href='http://localhost:8888/web_semi/login/pw_reset.jsp' style='padding-left:70px; text-decoration:none;color:#fff;font-size:18px;font-weight:bold;'>비밀번호 재설정</a></div>\n");
        sb.append("<div style='font-size:18px;'>\n" + 
