...
<body>
	...
	<div id ='main_f'><!-- 메인 -->
		<form id='frm_f' name='frm_f' method='post'>
			...
			<input type="hidden" name='place_f' id='place_f' value="${empty param.place_f?'구전체펜션,.,.,.':param.place_f }"/>
			...
			<div id ='mid_in_f'>
				<div id='left_f'>
					<div id='check_f'><!-- 체크박스 들어간 div -->
						...
						<div id='chk_f'><input type="checkbox" name='rest' id='public3_f' value=''/><label for='public3_f'><span></span>&nbsp;&nbsp;&nbsp;카페</label></div>
						<div id='chk_f'><input type="checkbox" name='cafe' id='public4_f' value=''/><label for='public4_f'><span></span>&nbsp;&nbsp;&nbsp;조식</label></div>
						<div id='chk_f'><input type="checkbox" name='bar' id='public5_f' value=''/><label for='public5_f'><span></span>&nbsp;&nbsp;&nbsp;바</label></div>
						...
						<div id='chk_f'><input type="checkbox" name='shower' id='private3_f' value=''/><label for='private3_f'><span></span>&nbsp;&nbsp;&nbsp;샤워실</label></div>
						<div id='chk_f'><input type="checkbox" name='aircon' id='private4_f' value=''/><label for='private4_f'><span></span>&nbsp;&nbsp;&nbsp;에어컨</label></div>
						<div id='chk_f'><input type="checkbox" name='spa' id='private5_f' value=''/><label for='private5_f'><span></span>&nbsp;&nbsp;&nbsp;스파</label></div>
					
						<h4>기타</h4>
						<div id='chk_f'><input type="checkbox" name='pet' id='etc1_f' value=''/><label for='etc1_f'><span></span>&nbsp;&nbsp;&nbsp;반려동물 동반</label></div>
						<div id='chk_f'><input type="checkbox" name='smoke' id='etc2_f' value=''/><label for='etc2_f'><span></span>&nbsp;&nbsp;&nbsp;객실내흡연</label></div>
