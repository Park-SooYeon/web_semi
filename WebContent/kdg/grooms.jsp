			...
			<div id ='mid_in_f'>
				<div id='left_f'>
					<div id='check_f'><!-- 체크박스 들어간 div -->
						...
						<h4>공용시설</h4>
						<div id='chk_f'><input type="checkbox" name='washer' id='public1_f' value=''/><label for='public1_f'><span></span>&nbsp;&nbsp;&nbsp;세탁기</label></div>
						<div id='chk_f'><input type="checkbox" name='lounge' id='public2_f' value=''/><label for='public2_f'><span></span>&nbsp;&nbsp;&nbsp;라운지</label></div>
						<div id='chk_f'><input type="checkbox" name='kitchen' id='public3_f' value=''/><label for='public3_f'><span></span>&nbsp;&nbsp;&nbsp;주방</label></div>
						<div id='chk_f'><input type="checkbox" name='dryer' id='public4_f' value=''/><label for='public4_f'><span></span>&nbsp;&nbsp;&nbsp;건조기</label></div>
						<div id='chk_f'><input type="checkbox" name='talsu' id='public5_f' value=''/><label for='public5_f'><span></span>&nbsp;&nbsp;&nbsp;탈수기</label></div>
						...
						<div id='chk_f'><input type="checkbox" name='refr' id='private3_f' value=''/><label for='private3_f'><span></span>&nbsp;&nbsp;&nbsp;냉장고</label></div>
						<div id='chk_f'><input type="checkbox" name='aircon' id='private4_f' value=''/><label for='private4_f'><span></span>&nbsp;&nbsp;&nbsp;에어컨</label></div>
						<div id='chk_f'><input type="checkbox" name='socket' id='private5_f' value=''/><label for='private5_f'><span></span>&nbsp;&nbsp;&nbsp;개인콘센트</label></div>
