			...
			<div id ='mid_in_f'>
				<div id='left_f'>
					<div id='check_f'><!-- 체크박스 들어간 div -->
						...
						<h3>상세조건</h3>
						<input type='button' name='btnReset' id='g_btnReset_f' class='btnReset_f' value='초기화'/>
						...
						<h4>공용시설</h4>
						<div id='chk_f'><input type="checkbox" name='public' id='public1_f' value=''/><label for='public1_f'><span></span>&nbsp;&nbsp;&nbsp;세탁기</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public2_f' value=''/><label for='public2_f'><span></span>&nbsp;&nbsp;&nbsp;라운지</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public3_f' value=''/><label for='public3_f'><span></span>&nbsp;&nbsp;&nbsp;주방</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public4_f' value=''/><label for='public4_f'><span></span>&nbsp;&nbsp;&nbsp;건조기</label></div>
						<div id='chk_f'><input type="checkbox" name='public' id='public5_f' value=''/><label for='public5_f'><span></span>&nbsp;&nbsp;&nbsp;탈수기</label></div>
						...
						<div id='chk_f'><input type="checkbox" name='private' id='private3_f' value=''/><label for='private3_f'><span></span>&nbsp;&nbsp;&nbsp;냉장고</label></div>
						<div id='chk_f'><input type="checkbox" name='private' id='private4_f' value=''/><label for='private4_f'><span></span>&nbsp;&nbsp;&nbsp;에어컨</label></div>
						<div id='chk_f'><input type="checkbox" name='private' id='private5_f' value=''/><label for='private5_f'><span></span>&nbsp;&nbsp;&nbsp;개인콘센트</label></div>
						...
						<div id='chk_f'><input type="checkbox" name='etc' id='etc4_f' value=''/><label for='etc4_f'><span></span>&nbsp;&nbsp;&nbsp;조식</label></div>
						<div id='chk_f'><input type="checkbox" name='etc' id='etc5_f' value=''/><label for='etc5_f'><span></span>&nbsp;&nbsp;&nbsp;주차</label></div>
						<div id='chk_f'><input type="checkbox" name='etc' id='etc6_f' value=''/><label for='etc6_f'><span></span>&nbsp;&nbsp;&nbsp;짐보관 가능</label></div>
					</div>
				</div>
				<div id ='right_f'>
					<div id ='search_f'><!-- 셀렉트된내용들 -->
						<div id='price_order_f'>
							<input type='button' name='btnAsc' id='g_btnAsc_f' class='btnAsc_f' value='낮은 가격순'/>
							<input type="button" name='btnDsc' id='g_btnDsc_f' class='btnDsc_f' value='높은 가격순'/>
						</div>
